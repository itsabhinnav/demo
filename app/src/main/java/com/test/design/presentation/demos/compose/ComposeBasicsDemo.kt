...
private fun StateSection() {
    ...
    CustomCard(modifier = Modifier.padding(vertical = NissanSpacing.md)) {
        Text(
            text = "Counter: $count",
...
private fun RecompositionSection() {
    ...
    Column(modifier = Modifier.padding(vertical = NissanSpacing.md)) {
...
private fun ModifierSection() {
    ...
    CustomCard(modifier = Modifier.padding(vertical = NissanSpacing.md)) {
        ...
        Text("Modifier.padding(16.dp)", style = MaterialTheme.typography.bodyLarge, modifier = Modifier.padding(top = NissanSpacing.sm))
        Text("Modifier.clickable { }", style = MaterialTheme.typography.bodyLarge, modifier = Modifier.padding(top = NissanSpacing.sm))
    }
}
